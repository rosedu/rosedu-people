# Django settings for rppl project.
...
DATABASES = {
    'default': {
        ...
        'NAME': BASEDIR + '/data/data.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = BASEDIR + '/resources/upload/'
...
SECRET_KEY = '%^m8ylf2^b5o1_o_3v3*s!h%0-_!opy0q@#yy$_r_&0jt*as!0'
